...
const messages = defineMessages({
  buttonApprove: {
    ...
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.buttonApprove',
  },
  buttonReject: {
    ...
    description:
      'Button to submit the validation form. Changes with the status of the validation.',
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.buttonReject',
  },
  explanation: {
    defaultMessage:
    ...
    id: 'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.explanation',
  },
  formFailure: {
    defaultMessage:
    ...
    id: 'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.formFailure',
  },
  inputLabel: {
    ...
    id: 'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.inputLabel',
  },
  radioDescriptionApprove: {
    ...
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.radioDescriptionApprove',
  },
  radioDescriptionReject: {
    ...
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.radioDescriptionReject',
  },
  radioLabelApprove: {
    ...
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.radioLabelApprove',
  },
  radioLabelReject: {
    defaultMessage: 'Request changes',
    description:
    ...
    id:
      'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.radioLabelReject',
  },
  radioLegend: {
    defaultMessage: 'Do you approve this answer?',
    description:
      'Label for the form field that allows a validator to pick "approve" or "deny".',
    id: 'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.radioLegend',
  },
  title: {
    ...
    id: 'components.ReferralDetailAnswerDisplay.ValidateAnswerForm.title',
  },
});
