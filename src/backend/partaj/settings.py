...
class SendinblueMixin:
    ...
    SENDINBLUE = {
        ...
        "REFERRAL_ANSWERED_REQUESTERS_TEMPLATE_ID": 44,
...
class Base(ElasticSearchMixin, SendinblueMixin, DRFMixin, Configuration):
    ...
    # notix api
    NOTIX_SERVER_URL = "http://api.notix-dev.snum-pnm3.fr"
    NOTIX_LOGIN = "api@notix-dev.snum-pnm3.fr"
    NOTIX_MDP = "aom7Yo7@ykzADYWUbUKu*YFu"
