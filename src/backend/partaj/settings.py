...
class SendinblueMixin:
    ...
    SENDINBLUE = {
        ...
        "REFERRAL_ANSWER_VALIDATION_REQUESTED_TEMPLATE_ID": 32,
        "REFERRAL_ANSWER_VALIDATED_TEMPLATE_ID": 31,
        "REFERRAL_ANSWER_NOT_VALIDATED_TEMPLATE_ID": 33,
        "REFERRAL_ANSWERED_TEMPLATE_ID": 8,
        "REFERRAL_ASSIGNED_TEMPLATE_ID": 28,
        "REFERRAL_ASSIGNED_UNIT_TEMPLATE_ID": 29,
        ...
        "REFERRAL_NEW_MESSAGE_FOR_UNIT_MEMBER_TEMPLATE_ID": 27,
        "REFERRAL_RECEIVED_TEMPLATE_ID": 30,
