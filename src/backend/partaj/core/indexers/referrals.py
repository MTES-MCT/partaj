...
class ReferralsIndexer:
    ...
    def get_es_document_for_referral(cls, referral, index=None, action="index"):
        ...
        if is_referral_answer_v2:
            if referral.report_id and referral.report and referral.report.pk and len(referral.report.versions.all()) > 0:
        ...
        return {
            ...
            "last_author": (
                ...
                if referral.report_id and referral.report and referral.report.pk and referral.report.get_last_version()
                else None
            ),
        }
