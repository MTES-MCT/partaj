"""
Referral subreferral confirmed history model in our core app.
"""
...
class SubReferralConfirmedHistory(models.Model):
    """
    ...
    referral = models.ForeignKey(
        ...
        help_text=_("Referral subject to the sub referral confirmed"),
        to="Referral",
    ...
    secondary_referral_id = models.TextField(
        verbose_name=_("main referral id"),
        help_text=_("newly confirmed id subreferral "),
    )

    class Meta:
        db_table = "partaj_subreferral_confirmed_history"
        verbose_name = _("referral subreferral confirmed history")
